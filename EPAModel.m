...
%                         mHH2                EMF                 round(EMF*numHH(i))];
    ...
    store_output(i,:) = [P1RP           P1H1           P1H2            P1IS        ...
                        P1HH           P2RP           P2H1            P2H2        ...
                        P2H3           P3RP           P3H3            H1RP        ...
                        H1C1           H1HH           H2RP            H2C1        ...
                        H2C2           H3RP           H3C2            C1RP        ...
                        C2RP           HHRP           ISIRP           RPP1        ...
                        RPP2           RPP3           RPIS            IRPP2       ...  
                        IRPP3          IRPRP          P1HHdemand      H1HHdemand  ...
                        ISHHdemand     P1ISdemand     RPISdemand      P1production...
                        H1production   ISproduction   pP1             pH1         ...
                        pIS            percapbirths   weightedprice   W           ...
                        W1             W2             P1HHdemand1     P1HHdemand2 ...
                        H1HHdemand1    H1HHdemand2    ISHHdemand1     ISHHdemand2 ...
                        EEHHdemand1    EEHHdemand2    pEE             EEHHdemand  ...
                        EEHHtotdemand  EEISdemand     EEproduction    EEHHmass    ...
                        EEIRP          percapbirths1  percapbirths2   mHH1        ...
                        mHH2           EMF            round(EMF*numHH(i))]   ;
...
y = [P1'              P2'              P3'              H1'             ...
     H2'              H3'              C1'              C2'             ...
     HH'              ISmass'          RP'              IRP'            ...
     numHH'           percapmass'      P1H1massdeficit' P1ISmassdeficit'...
     P1HHmassdeficit' H1massdeficit'   ISmassdeficit'   numHH1'         ...
     numHH2'          HH1'             HH2'             ERP'            ...
     EE'              CO2eq'];
end  